[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(HayvanDostu.MVC.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(HayvanDostu.MVC.App_Start.NinjectWebCommon), "Stop")]

namespace HayvanDostu.MVC.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IMainPageOptionsService>().To<MainPageOptionsService>();
